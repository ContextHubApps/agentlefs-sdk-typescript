...
import * as ContexthubApi from "./api/index.js";
...
export declare namespace ContexthubApiClient {
    export type Options = BaseClientOptions;

    export interface RequestOptions extends BaseRequestOptions {}
}

export class ContexthubApiClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<ContexthubApiClient.Options>;
    ...
    constructor(options: ContexthubApiClient.Options = {}) {
     ...
     *
     * @param {ContexthubApi.SearchRequest} request
     * @param {ContexthubApiClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public search(
        request: ContexthubApi.SearchRequest,
        requestOptions?: ContexthubApiClient.RequestOptions,
    ): core.HttpResponsePromise<ContexthubApi.SearchResults> {
    ...
    private async __search(
        request: ContexthubApi.SearchRequest,
        requestOptions?: ContexthubApiClient.RequestOptions,
    ): Promise<core.WithRawResponse<ContexthubApi.SearchResults>> {
        ...
        if (_response.ok) {
            return { data: _response.body as ContexthubApi.SearchResults, rawResponse: _response.rawResponse };
        }
